...
# --- ODSTRANĚNA FUNKCE _find_package_name (je v common) ---
...
def find_and_rename_output(logger, params, env_vars):
    ...
    # --- ZMĚNA: Použití importované funkce ---
    ...
    env_lc = env.lower() 
    combined_flavor = ""
    if flavor and env_camel: combined_flavor = f"{flavor}{env_camel}"
    elif flavor: combined_flavor = flavor
    ...
    if build_type == "apk":
        ...
        candidates.extend([
            ...
            f"build/app/outputs/bundle/{mode}/app-release.aab"
        ])
